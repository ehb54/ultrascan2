...
#pragma warning ( default: 4251 )
      ...
      QLabel *lbl_banner2;
      QLabel *lbl_odCutoff;
      QLabel *lbl_lambdaLimitLeft;
      QLabel *lbl_lambdaLimitRight;
   ...
   private:
      ...
      bool print_plot;
      float odCutoff, lambdaLimitLeft, lambdaLimitRight, pathlength, extinction_coefficient, factor, selected_wavelength;
      QString htmlDir;
...
//      void resizeEvent(QResizeEvent *e);
   ...
   public slots:
      ...
      void update_lambdaLimitLeft(const QString &);
      void update_lambdaLimitRight(const QString &);
